...
public class NativeStressTest {
    ...
    private List<DBusConnection> createClientConnections(int numberOfClients) throws DBusException {
        ...
        for (int i = 0; i < numberOfClients; i++) {
            clientConnections.add(DBusConnection.newConnection(DBusConnection.DBusBusType.SESSION));
        }
    ...
    private List<DBusConnection> createServices(int numberOfServices) throws DBusException {
        ...
        for (int i = 0; i < numberOfServices; i++) {
            ...
            DBusConnection serviceConnection = DBusConnection.newConnection(DBusConnection.DBusBusType.SESSION);
